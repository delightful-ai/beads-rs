...
fn store_lock_op_error(err: crate::runtime::store::lock::StoreLockError) -> OpError {
...
fn lock_meta_to_api(meta: crate::runtime::store::lock::StoreLockMeta) -> StoreLockMetaOutput {
    StoreLockMetaOutput {
