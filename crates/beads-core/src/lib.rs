...
pub use wire_bead::{
    ...
    TxnOpV1, WireBeadFull, WireBeadPatch, WireClaimSnapshot, WireDepAddV1, WireDepRemoveV1,
    WireDotV1, WireDvvV1, WireFieldStamp, WireLabelAddV1, WireLabelRemoveV1, WireLabelStateV1,
    WireLineageStamp, WireNoteV1, WirePatch, WireStamp, WireTombstoneV1, WireWorkflowSnapshot,
    WorkflowStatus,
};
