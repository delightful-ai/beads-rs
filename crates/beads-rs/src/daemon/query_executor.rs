...
impl Daemon {
    ...
    /// Get a single bead.
    pub(in crate::daemon) fn query_show(
        &mut self,
        repo: &Path,
        id: &BeadId,
        read: ReadConsistency,
    ...
    pub(in crate::daemon) fn query_show_multiple(
        &mut self,
        repo: &Path,
        ids: &[BeadId],
        read: ReadConsistency,
    ...
    pub(in crate::daemon) fn query_show_details(
        &mut self,
        repo: &Path,
        id: &BeadId,
        read: ReadConsistency,
    ...
    pub(in crate::daemon) fn query_list(
        &mut self,
        repo: &Path,
        filters: &Filters,
        read: ReadConsistency,
    ...
    pub(in crate::daemon) fn query_ready(
        &mut self,
        repo: &Path,
        limit: Option<usize>,
        read: ReadConsistency,
    ...
    pub(in crate::daemon) fn query_dep_tree(
        &mut self,
        repo: &Path,
        id: &BeadId,
        read: ReadConsistency,
    ...
    pub(in crate::daemon) fn query_deps(
        &mut self,
        repo: &Path,
        id: &BeadId,
        read: ReadConsistency,
    ...
    pub(in crate::daemon) fn query_notes(
        &mut self,
        repo: &Path,
        id: &BeadId,
        read: ReadConsistency,
    ...
    pub(in crate::daemon) fn query_status(
        &mut self,
        repo: &Path,
        read: ReadConsistency,
        git_tx: &Sender<GitOp>,
    ...
    /// Get blocked issues.
    pub(in crate::daemon) fn query_blocked(
        &mut self,
        repo: &Path,
        read: ReadConsistency,
        git_tx: &Sender<GitOp>,
    ...
    pub(in crate::daemon) fn query_stale(
        &mut self,
        repo: &Path,
        days: u32,
        status: Option<&str>,
    ...
    pub(in crate::daemon) fn query_count(
        &mut self,
        repo: &Path,
        filters: &Filters,
        group_by: Option<&str>,
    ...
    pub(in crate::daemon) fn query_deleted(
        &mut self,
        repo: &Path,
        since_ms: Option<u64>,
        id: Option<&BeadId>,
    ...
    pub(in crate::daemon) fn query_epic_status(
        &mut self,
        repo: &Path,
        eligible_only: bool,
        read: ReadConsistency,
    ...
    /// Validate state.
    pub(in crate::daemon) fn query_validate(
        &mut self,
        repo: &Path,
        read: ReadConsistency,
        git_tx: &Sender<GitOp>,
    ...
    /// Dependency cycles.
    pub(in crate::daemon) fn query_dep_cycles(
        &mut self,
        repo: &Path,
        read: ReadConsistency,
        git_tx: &Sender<GitOp>,
