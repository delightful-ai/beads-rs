...
Depends on: `src/cli/mod.rs` types and `src/daemon/ipc.rs` requests.
...
- For JSON mode: print structured payloads; for human mode: render from the command module itself.
