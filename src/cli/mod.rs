...
pub fn run(cli: Cli) -> Result<()> {
    ...
    match cli.command {
        Commands::Daemon { cmd } => commands::daemon::handle(cmd),
        ...
        cmd => {
            ...
            match cmd {
                ...
                Commands::Reopen(args) => commands::reopen::handle(&ctx, args),
                Commands::Delete(args) => commands::delete::handle(&ctx, args),
                Commands::Claim(args) => commands::claim::handle(&ctx, args),
                Commands::Unclaim(args) => commands::unclaim::handle(&ctx, args),
