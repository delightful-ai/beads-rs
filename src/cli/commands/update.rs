...
pub struct UpdateArgs {
    ...
    #[arg(short = 's', long, value_parser = super::super::parse_status)]
    pub status: Option<String>,

    /// Close reason (for status=closed).
    #[arg(long, allow_hyphen_values = true)]
    ...
    /// Labels to add (repeat or comma-separated).
    #[arg(long = "add-label", alias = "add_label", value_delimiter = ',', num_args = 0..)]
    pub add_label: Vec<String>,

    /// Labels to remove (repeat or comma-separated).
