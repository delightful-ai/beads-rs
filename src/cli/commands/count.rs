...
pub struct CountArgs {
    ...
    #[arg(long = "by-status", conflicts_with_all = ["by_priority", "by_type", "by_assignee", "by_label"])]
    pub by_status: bool,

    /// Group results by priority.
    #[arg(long = "by-priority", conflicts_with_all = ["by_status", "by_type", "by_assignee", "by_label"])]
    pub by_priority: bool,

    /// Group results by type.
    #[arg(long = "by-type", conflicts_with_all = ["by_status", "by_priority", "by_assignee", "by_label"])]
    pub by_type: bool,

    /// Group results by assignee.
    #[arg(long = "by-assignee", conflicts_with_all = ["by_status", "by_priority", "by_type", "by_label"])]
    pub by_assignee: bool,

    /// Group results by label.
    #[arg(long = "by-label", conflicts_with_all = ["by_status", "by_priority", "by_type", "by_assignee"])]
    pub by_label: bool,
}
