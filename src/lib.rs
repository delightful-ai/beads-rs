...
pub use crate::core::{
    ...
    ReplicaEntry, ReplicaRole, ReplicaRoster, ReplicaRosterError, ReplicatedProof, RetentionPolicy,
    SegmentId, Seq0, Seq1, Sha256, Stamp, StoreEpoch, StoreId, StoreIdentity, StoreMeta,
    StoreMetaVersions, StoreState, Tombstone, TtlBasis, TxnDeltaError, TxnDeltaV1, TxnId,
    TxnOpKey, TxnOpV1, VerifiedEvent, VerifiedEventAny, WallClock, Watermark, WatermarkError,
    Watermarks, WireBeadFull, WireBeadPatch, WireDepDeleteV1, WireDepV1, WireFieldStamp,
    WireNoteV1, WirePatch, WireStamp, WireTombstoneV1, Workflow, WorkflowStatus, WriteStamp,
    apply_event, decode_event_body, decode_event_hlc_max, encode_event_body_canonical,
