...
pub use crate::core::{
    ...
    ClientRequestId, Closure, DecodeError, DepEdge, DepKey, DepKind, DurabilityClass,
    ...
    TxnDeltaV1, TxnId, TxnOpKey, TxnOpV1, TxnV1, VerifiedEvent, VerifiedEventAny, WallClock,
    Watermark, WatermarkError, Watermarks, WireBeadFull, WireBeadPatch, WireDepDeleteV1, WireDepV1,
