...
pub use crate::core::{
    ...
    Canonical, CanonicalState, CheckpointGroup, Claim, ClientRequestId, Closure, DecodeError,
    DepEdge, DepKey, DepKind, DurabilityClass, DurabilityOutcome, DurabilityProofV1,
