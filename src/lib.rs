...
pub use crate::core::{
    ...
    PrevDeferred, PrevVerified, Priority, ReceiptMergeError, ReplicaEntry, ReplicaId, ReplicaRole,
    ...
    StoreState, Tombstone, TtlBasis, TxnDeltaError, TxnDeltaV1, TxnId, TxnOpKey, TxnOpV1,
