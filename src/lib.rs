...
pub use crate::core::{
    ...
    StoreMeta, StoreMetaVersions, StoreState, Tombstone, TtlBasis, TxnDeltaError, TxnDeltaV1,
    TxnId, TxnOpKey, TxnOpV1, TxnV1, VerifiedEvent, VerifiedEventAny, WallClock, Watermark,
